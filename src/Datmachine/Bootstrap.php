...
class Bootstrap
{
    ...
    {
        spl_autoload_register(array('\Datmachine\Bootstrap', 'autoload'));
    ...
    {
        spl_autoload_register(array('\Datmachine\Bootstrap', 'pharAutoload'));
        self::initializeResources();
    }
    ...
    private static function initializeResources()
    {
        ...
        \Datmachine\Resource::init();
        \Datmachine\Subscription::init();
        \Datmachine\Customer::init();
        \Datmachine\Plan::init();
